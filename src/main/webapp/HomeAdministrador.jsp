...
<body>
    ...
    <nav>
        ...
        <a href="${pageContext.request.contextPath}/ZonaAdmin">Zonas Forestales</a>
        <a href="${pageContext.request.contextPath}/EspecieAdmin">Especies</a>
        <a href="${pageContext.request.contextPath}/ActividadAdmin">Actividades</a>
